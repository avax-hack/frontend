...
export function FeaturedProjectCard({ project }: FeaturedProjectCardProps) {
  ...
  const cls = "group relative flex flex-col overflow-hidden rounded-xl border border-white/10 bg-white/5 transition-all hover:border-red-500/30 hover:shadow-lg hover:shadow-red-500/10"
