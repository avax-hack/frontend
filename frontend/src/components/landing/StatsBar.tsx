...
export function StatsBar({
  ...
  return (
    <div className="mx-auto grid w-full max-w-5xl grid-cols-2 gap-6 rounded-xl border border-white/10 bg-black/40 px-6 py-6 backdrop-blur-md lg:grid-cols-4 lg:gap-8">
      {stats.map((stat) => (
